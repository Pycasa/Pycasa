...
We aim to support the latest released version of `Pycasa` and the most recent minor version prior to it. Older versions may receive fixes on a best-effort basis.
