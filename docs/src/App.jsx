...
const installCommands = {
  ...
  docker: {
    comment: '# Run with Docker',
    cmd: 'docker run -d -p 3000:3000 -v ~/Pictures:/photos --name pycasa pycasa/pycasa:latest',
  },
  build: {
    comment: '# Build from source',
    cmd: 'git clone https://github.com/pycasa/pycasa.git && cd Pycasa && make build',
  },
};
