...
export default function App() {
    ...
    const sharedNav = (
        <Navbar page={page} navScrolled={navScrolled} onHome={goHome} onHowTos={goToHowTos} />
    );
        ...
        <div className="root-wrap">
            ...
            <div>
                ...
                <section className="hero">
                    ...
                    <h1>
                        Your photos, your server, <span className="gradient-text">your rules.</span>
                    </h1>
                    <p className="hero-sub">
                        Pycasa is a self-hosted photo manager that runs entirely on your own
                        machine. Point it at your photo folders and get a fast, searchable gallery
                        with AI-powered descriptions and tags — all processed locally.
                    </p>
                ...
                <section id="features" className="section-features">
                    ...
                    <p className="section-sub">
                        Built for people who care about privacy and want a great photo experience
                        without the cloud.
                    </p>
                        ...
                        {[
                            {
                                ...
                                desc: 'Point Pycasa at any folder on your machine. Use the built-in filesystem browser or type the path directly.',
                            },
                            {
                                n: '02',
                                title: 'Pycasa scans & indexes',
                                desc: 'A background scan walks your folders recursively, indexing every image into the embedded Couchbase Lite database.',
                            },
                            {
                                n: '03',
                                title: 'AI analyses your photos',
                                desc: 'Trigger batch analysis and your local Ollama instance (or cloud AI) generates rich descriptions and tags for every image.',
                            },
                            {
                                n: '04',
                                title: 'Browse, search & discover',
                                desc: 'Use the Timeline or Gallery view to browse. Search by description, filter by tags, sort by date or size — instantly.',
                            },
                        ].map((step) => (
                ...
                <section id="ai" className="section-ai">
                    ...
                    <p className="section-sub">
                        Flexible AI - Run AI locally with Ollama, or connect to Gemini or OpenAI.
                            ...
                            {activeProvider === 0 && (
                                <div className="ai-code-block">
                                    ...
                                    <pre className="code-body">
                                        ...
                                        <span className="code-cmd">ollama pull llava</span>
                                        {'\n'}
                                        <span className="code-prompt">$</span>{' '}
                                        ...
                                        {'\n'}
                                        <span className="code-comment">
                                            # Then open Pycasa → Settings → AI Settings
                                        </span>
                                    </pre>
                                </div>
                            )}
                        ...
                        <div className="creds-row">
                            ...
                            <div className="creds-item">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="creds-value creds-link"
                                >
                                    http://localhost:3000
                                </a>
                            </div>
                        ...
                        <div className="creds-row">
                            ...
                            <div className="creds-item">
                                ...
                                <span className="creds-value">
                                    ...
                                    <span className="creds-sep"> Password: </span>{' '}
                                    <code>admin</code>
                                </span>
                            </div>
                        </div>
            ...
            <footer>
                <div className="footer-inner">
                    ...
                    <div className="footer-links">
                        ...
                        <a
                            href="https://github.com/pycasa/pycasa/issues"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            Issues
                        ...
                        <a href="https://quarkus.io" target="_blank" rel="noopener noreferrer">
                            Quarkus
                        </a>
                    </div>
