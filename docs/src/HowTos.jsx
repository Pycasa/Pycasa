            ...
            {sections.map((s) => {
              ...
              return (
                <button
                  ...
                  style={isActive ? { color: c.accent, borderLeftColor: c.accent, background: c.bg } : {}}
        ...
        <main className="ht-main">
          ...
          <div className="ht-header">
            ...
            <p className="ht-subtitle">
              Everything you need to get the most out of Pycasa — from adding folders to running AI analysis.
            </p>
          </div>
                ...
                <section key={sec.id} id={sec.id} className="ht-section">
                  ...
                  {sec.steps.map((block) => (
                    <div key={block.heading} className="ht-block">
                      <h3 className="ht-block-heading" style={{ color: c.accent }}>
                        {block.heading}
                      </h3>
                  ...
                  {sec.tip && (
                    <div className="ht-tip" style={{ borderColor: c.border, background: c.bg }}>
                      <span className="ht-tip-label" style={{ color: c.accent }}>💡 Tip</span>
                      <p>{sec.tip}</p>
                    </div>
                  )}
                </section>
